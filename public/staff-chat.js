...
function renderMessages(){var l=document.getElementById('scList');if(!l)return;
 ...
 l.querySelectorAll('[data-task]').forEach(function(b){b.onclick=function(){_homeGotoBoardTask(b.dataset.task);};});
}
