...
(async()=>{
 ...
 for(const file of ['staff-comment-photos.js','staff-workspace-task.js','staff-related-tasks.js','staff-workspace-media.js'])await staff.addScriptTag({path:path.join(root,'public',file)});
