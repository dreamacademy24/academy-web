    ...
    <div className="iw">
      ...
      <div className="iv" id="guest-invoice">
        ...
        <div className="is"><div className="ist">Billing Details</div>
          ...
          <div style={{marginTop:14,padding:"16px 20px",background:"rgb(99,74,244)",color:"#fff",border:"1px solid rgb(99,74,244)",borderRadius:10,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
