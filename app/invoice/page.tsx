...
.tb{width:100%;border-collapse:collapse;border-radius:10px;overflow:hidden;}.tb th{font-size:11px;font-weight:700;color:#6d28d9;padding:10px 12px;text-align:left;background:#f5f3ff;border:1px solid #ede9fe;}.tb td{font-size:13px;padding:11px 12px;border:1px solid #ede9fe;color:#334155;line-height:1.6;}.tb tbody tr:nth-child(even) td{background:#faf5ff;}.tb .lb{font-weight:600;background:#f5f3ff;width:28%;color:#475569;font-size:12px;}.tb .dc{color:#be185d;font-weight:700;}.tb .tr td{font-weight:800;font-size:15px;background:#ede9fe;color:#4c1d95;}.tb .fr td{font-weight:900;font-size:20px;background:linear-gradient(135deg,#a78bfa 0%,#60a5fa 100%);color:#fff;padding:14px 12px;}
