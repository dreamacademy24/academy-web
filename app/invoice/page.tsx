...
.fw{max-width:800px;margin:0 auto;padding:40px 24px 60px;}.fh{text-align:center;margin-bottom:32px;}.fh h1{font-size:28px;font-weight:800;margin-bottom:6px;color:#6d28d9;}.fh p{font-size:14px;color:#64748b;}
.fs{background:#fff;border-radius:16px;padding:24px;box-shadow:0 2px 8px rgba(167,139,250,0.08);margin-bottom:20px;border:1px solid #ede9fe;}.fs h2{font-size:16px;font-weight:800;margin-bottom:16px;padding-bottom:10px;border-bottom:2px solid #ede9fe;display:flex;align-items:center;gap:8px;color:#6d28d9;}
...
.f-input,.f-select,.f-textarea{width:100%;padding:10px 12px;border:1px solid #e0e7ff;border-radius:10px;font-size:13px;font-family:'Noto Sans KR',sans-serif;outline:none;background:#fff;transition:border-color .15s,box-shadow .15s;}.f-input:focus,.f-select:focus,.f-textarea:focus{border-color:#a78bfa;box-shadow:0 0 0 3px rgba(167,139,250,0.12);}.f-textarea{resize:vertical;min-height:60px;}.f-input.auto{background:#f5f3ff;border-color:#ddd6fe;color:#6d28d9;font-weight:600;}
.mt{display:flex;gap:4px;background:#f5f3ff;border-radius:10px;padding:4px;margin-bottom:16px;}.mb{flex:1;padding:10px;font-size:13px;font-weight:700;text-align:center;border:none;border-radius:7px;cursor:pointer;font-family:'Noto Sans KR',sans-serif;background:transparent;color:#64748b;transition:all 160ms;}.mb:hover{color:#6d28d9;}.mb.ac{background:linear-gradient(135deg,#a78bfa 0%,#60a5fa 100%);color:#fff;box-shadow:0 2px 8px rgba(167,139,250,0.35);}
.ab{padding:16px;background:#f5f3ff;border:1px solid #ede9fe;border-radius:12px;margin-bottom:12px;}.ab-l{font-size:12px;font-weight:700;color:#6d28d9;margin-bottom:10px;}.cp{text-align:center;padding:4px 0;font-size:22px;font-weight:800;color:#6d28d9;}
.er{padding:20px;background:linear-gradient(135deg,#f5f3ff 0%,#dbeafe 100%);border:1px solid #ddd6fe;border-radius:14px;margin-top:16px;}.erl{font-size:13px;color:#475569;margin-bottom:6px;line-height:1.7;}.erl strong{color:#1e293b;}.erl .dm{color:#94a3b8;font-size:12px;}
.ert{margin-top:12px;padding-top:12px;border-top:2px solid #c4b5fd;display:flex;justify-content:space-between;align-items:center;font-size:16px;font-weight:800;}.ert .pr{color:#6d28d9;font-size:26px;}
...
.ba{width:100%;padding:12px;background:linear-gradient(135deg,#a78bfa 0%,#60a5fa 100%);color:#fff;font-size:14px;font-weight:700;border:none;border-radius:10px;cursor:pointer;font-family:'Noto Sans KR',sans-serif;margin-top:12px;transition:opacity 160ms;box-shadow:0 2px 8px rgba(167,139,250,0.25);}.ba:hover{opacity:0.9;}
.ex-box{padding:14px 16px;background:#fdf4ff;border:1px solid #fae8ff;border-radius:12px;margin-bottom:12px;}.ex-title{font-size:11px;font-weight:700;color:#a21caf;margin-bottom:8px;}.ex-row{display:flex;gap:12px;align-items:flex-end;}
.ne{padding:20px;text-align:center;color:#a78bfa;font-size:13px;background:#faf5ff;border:1px dashed #ddd6fe;border-radius:12px;margin-top:16px;}
...
.bg{width:100%;padding:14px;background:linear-gradient(135deg,#a78bfa 0%,#60a5fa 100%);color:#fff;font-size:15px;font-weight:700;border:none;border-radius:12px;cursor:pointer;font-family:'Noto Sans KR',sans-serif;margin-top:8px;box-shadow:0 2px 10px rgba(167,139,250,0.3);transition:opacity 160ms;}.bg:hover{opacity:0.92;}.bl{display:block;text-align:center;margin-top:16px;font-size:13px;color:#64748b;}.bl:hover{color:#6d28d9;}
.sc{position:relative;padding:20px;background:#fff;border:1px solid #ede9fe;border-radius:14px;margin-bottom:12px;box-shadow:0 1px 4px rgba(167,139,250,0.06);}.sc-del{position:absolute;top:10px;right:10px;width:28px;height:28px;display:flex;align-items:center;justify-content:center;background:#fce7f3;color:#9f1239;border:1px solid #fbcfe8;border-radius:8px;cursor:pointer;font-size:14px;font-weight:700;}.sc-del:hover{background:#fbcfe8;}.sc-num{font-size:12px;font-weight:700;color:#6d28d9;margin-bottom:12px;}
.f-hint{font-size:10px;color:#a78bfa;margin-top:2px;}
.iw{max-width:860px;margin:0 auto;padding:40px 24px 60px;}.iv{background:#fff;padding:48px 40px;box-shadow:0 4px 24px rgba(167,139,250,0.12);border-radius:20px;overflow:hidden;}
.it{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;padding:24px 28px;margin:-48px -40px 32px;background:linear-gradient(135deg,#e9d5ff 0%,#dbeafe 60%,#fce7f3 100%);border-radius:20px 20px 0 0;}.il{font-family:'Montserrat',sans-serif;font-size:22px;font-weight:900;color:#4c1d95;}.ils{font-size:11px;color:#7c3aed;font-weight:500;letter-spacing:0.05em;}.itr{text-align:right;}.itr h1{font-family:'Montserrat',sans-serif;font-size:30px;font-weight:900;letter-spacing:0.08em;color:#6d28d9;}.itr p{font-size:11px;color:#7c3aed;margin-top:2px;}
.is{margin-bottom:28px;}.ist{font-family:'Montserrat',sans-serif;font-size:12px;font-weight:800;letter-spacing:0.1em;text-transform:uppercase;color:#7c3aed;margin-bottom:10px;padding-bottom:6px;border-bottom:1px solid #ede9fe;}
.tb{width:100%;border-collapse:collapse;border-radius:10px;overflow:hidden;}.tb th{font-size:11px;font-weight:700;color:#6d28d9;padding:10px 12px;text-align:left;background:#f5f3ff;border:1px solid #ede9fe;}.tb td{font-size:13px;padding:11px 12px;border:1px solid #ede9fe;color:#334155;line-height:1.6;}.tb tbody tr:nth-child(even) td{background:#faf5ff;}.tb .lb{font-weight:600;background:#f5f3ff;width:28%;color:#475569;font-size:12px;}.tb .dc{color:#be185d;font-weight:700;}.tb .tr td{font-weight:800;font-size:15px;background:#ede9fe;color:#4c1d95;}.tb .fr td{font-weight:900;font-size:20px;background:linear-gradient(135deg,#f5f3ff 0%,#ede9fe 100%);color:#1f2937;padding:14px 12px;border-top:1px solid #ddd6fe;}
.ift{margin-top:32px;padding:20px;background:#fdf4ff;border:1px solid #fae8ff;border-radius:12px;font-size:12px;color:#6b21a8;line-height:1.8;word-break:keep-all;}
.pb{display:flex;gap:10px;justify-content:center;margin-top:24px;flex-wrap:wrap;}.pp{padding:12px 32px;background:linear-gradient(135deg,#a78bfa 0%,#60a5fa 100%);color:#fff;font-size:14px;font-weight:700;border:none;border-radius:10px;cursor:pointer;font-family:'Noto Sans KR',sans-serif;box-shadow:0 2px 8px rgba(167,139,250,0.28);}.pp:hover{opacity:0.92;}.prc{padding:12px 32px;background:linear-gradient(135deg,#86efac 0%,#22d3ee 100%);color:#064e3b;font-size:14px;font-weight:700;border:none;border-radius:10px;cursor:pointer;font-family:'Noto Sans KR',sans-serif;box-shadow:0 2px 8px rgba(34,197,94,0.22);}.prc:hover{opacity:0.92;}.psv{padding:12px 32px;background:#e0e7ff;color:#3730a3;font-size:14px;font-weight:700;border:none;border-radius:10px;cursor:pointer;font-family:'Noto Sans KR',sans-serif;}.psv:hover{background:#c7d2fe;}.pci{padding:8px 20px;background:#fff;color:#64748b;font-size:12px;font-weight:600;border:1px solid #ede9fe;border-radius:10px;cursor:pointer;font-family:'Noto Sans KR',sans-serif;margin-top:8px;}.pci:hover{background:#f5f3ff;color:#6d28d9;}.pbk{padding:12px 32px;background:#f5f3ff;color:#6d28d9;font-size:14px;font-weight:600;border:1px solid #ede9fe;border-radius:10px;cursor:pointer;font-family:'Noto Sans KR',sans-serif;}.pbk:hover{background:#ede9fe;}
