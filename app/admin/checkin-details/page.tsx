...
@media(max-width:700px){.cd-w{padding:24px 12px}.fr{grid-template-columns:1fr}}
    ...
    <div className="cd-w">
      ...
      {booking && selId && <div className="sec" style={{display:'flex',gap:12,alignItems:'center',flexWrap:'wrap'}}>
        <strong>{booking.booker_name} · 서류</strong>
        ...
        <a className="btn btn-gray" href={'/admin/checkin-print?bookings='+encodeURIComponent(selId)} target="_blank" rel="noopener">전체·항목별 출력</a>
