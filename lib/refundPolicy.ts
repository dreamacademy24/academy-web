...
const COMMON_REFUND_RULE: PolicySection = {
  ...
  title: "환불 및 변경 규정",
  bullets: [
    "1. 등록 후 취소, 환불, 일정 변경은 불가하며, 패키지 일부만 변경·취소도 불가능합니다. (예: 숙소만 이용 / 수업만 이용 / 식사 제외 등 부분 선택 불가)",
    ...
    "4. 환불 기준: 출국 6주 전 취소 시에는 예약금을 제외한 잔금의 50% 환불이 가능합니다. 출국 6주 이내 취소 또는 입실 후 개인 사정으로 인한 중도 퇴실의 경우에는 환불이 불가합니다.",
...
export const REFUND_POLICY_VERSION = "2026-06-12";
